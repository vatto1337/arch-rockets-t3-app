      ...
      <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
        <div className="max-w-4xl">
          ...
          <div className="mt-3 font-light leading-normal  text-gray-600 lg:text-xl">
            Explore the incredible engineering and innovation behind SpaceX's
            fleet of rockets. Click on each rocket to learn more about its
            unique features, mission history, and technological advancements
